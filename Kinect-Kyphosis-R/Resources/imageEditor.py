...
class CVEditor:
    ...
    def displayAMessageToCV(self, img, message, beginRectangleCoord, endrectangleCoord, startTextCoord): 
        tempImg = cv2.rectangle(img, beginRectangleCoord, endrectangleCoord, (0,0,255), -1)
        tempImg = cv2.putText(img, message,startTextCoord, cv2.FONT_HERSHEY_SIMPLEX, 0.5, (0,255,0), 2)
        return tempImg
