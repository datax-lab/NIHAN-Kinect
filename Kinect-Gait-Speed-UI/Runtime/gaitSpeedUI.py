...
# UI Imports
from UI import controlCenterGait, gaitSpdGeneral, gaitSpdAverageUI
...
class controlPanelGait(QDialog):
    ...
    def setInfoNRun(self,id, name, database = None): 
        ...
        self.gaitProgram.setDatabaseInstance(database)
    ...
    def signalStartProgram(self): 
        ...
        if self.gaitProgram._startDistanceCaptured:
                ...
                if self.gaitProgram._PAUSE is False:
                    ...
                    self.gaitProgram._Timer.starTtimer(True)
    ...
    def signalExit(self, booleanVal): 
        if booleanVal:
...
class gaitSpdUI(QDialog):
    ...
    def showGraph(self): 
        self.gaitProRef.plot.plotPts("Distance (m)", "Speed (m/s)")
        self.gaitProRef.plot.showPlt()
